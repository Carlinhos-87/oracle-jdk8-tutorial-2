...
public class App {
	public static void main(String[] args) {
		...
		/* Sentencia do - while
		 * 
		 * La condicion se evalua al final, no al principio como en la sentencia while, por lo que
		 * si se necesita ejecutar el bloque de instrucciones que estan entre las llaves de apertura
		 * y cierre, una vez al menos, pues esta es la sentencia indicada*/
